...
////////////////////////////////////////////////////////////// // ncc
	void setNCCSchedule(EVMSchedule _nccSchedule) const { nccSchedule = _nccSchedule; }

	EVMSchedule& getNCCSchedule() const { return nccSchedule; }
...
private:
	...
	mutable EVMSchedule nccSchedule; // ncc
