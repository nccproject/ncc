...
#include "genesis/nccMainNetwork.cpp"
...
#include "genesis/test/nccTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::nccMainNetwork: return c_genesisInfoNCCMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::nccTestNetwork: return c_genesisInfoNCCTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::nccMainNetwork: return c_genesisStateRootNCCMainNetwork;
    case Network::nccTestNetwork: return c_genesisStateRootNCCTestNetwork;
