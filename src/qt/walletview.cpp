    ...
    platformStyle(_platformStyle)
{
    ...
    NCCTokenPage = new NCCToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    NCCTokenPage->setClientModel(_clientModel);
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    NCCTokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(NCCTokenPage);
    NCCTokenPage->on_goToSendTokenPage();
}

void WalletView::gotoReceiveTokenPage()
{
    setCurrentWidget(NCCTokenPage);
    NCCTokenPage->on_goToReceiveTokenPage();
}

void WalletView::gotoAddTokenPage()
{
    setCurrentWidget(NCCTokenPage);
    NCCTokenPage->on_goToAddTokenPage();
}
