...
QString BitcoinUnits::longName(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μNCC (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("NCCs");
    case mBTC: return QString("Milli-NCCs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-NCCs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
