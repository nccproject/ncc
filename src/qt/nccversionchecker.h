#ifndef NCCVERSIONCHECKER_H
#define NCCVERSIONCHECKER_H

#include <QObject>

#define NCC_RELEASES "https://github.com/nccproject/ncc/releases"
...
class NCCVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit NCCVersionChecker(QObject *parent = 0);
    ~NCCVersionChecker();
