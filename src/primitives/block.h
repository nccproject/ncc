...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // ncc
        hashUTXORoot.SetNull(); // ncc
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //ncc
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //ncc
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //ncc
    {
